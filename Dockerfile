...
RUN bash -c 'source /opt/ros/kinetic/setup.bash && export ROS_PACKAGE_PATH=${ROS_PACKAGE_PATH}:/opt/ORB_SLAM2/Examples/ROS/ && cd /opt/ORB_SLAM2/ && sh build_ros.sh' || echo "force success"
